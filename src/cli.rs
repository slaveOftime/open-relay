...
pub struct SendArgs {
    ...
    /// Prefix with oly-content:clipboard to send clipboard text or uploaded clipboard files.
    /// Prefix with oly-content:<path> to upload a local file and send the saved session path.
